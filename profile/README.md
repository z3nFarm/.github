...
Защитите ваши чувствительные данные (пароли, приватные ключи, API ключи) используя нашу систему шифрования:

### Шаги настройки

1. **Скачать**: [_SAFU.zp и _vars.zp](https://github.com/z3nFarm/_SAFU)
2. **Расположение**: Поместите оба файла внутрь папки `.internal` в папке с вашими шаблонами
3. **Конфигурация**:
   - Откройте `_vars.zp` в ProjectMaker
   - Введите пароли в соответствующие поля
   - Измените права доступа
4. **Документация**: [Подробное руководство SAFU](https://z3n-1.gitbook.io/z3n/getting-started/safu)

> ⚠️ **Важно**: Никогда не коммитьте `_vars.zp` с реальными данными в репозиторий.

---

## 📊 Импорт данных

Используйте шаблон `_dbTools` для инициализации структуры БД и импорта необходимых данных:

1. **Скачать**: [Шаблон _dbTools](https://github.com/z3nFarm/_dbTools/tree/master)
2. **Запустить** шаблон в режиме **build** с выбранной БД
3. **Следовать** инструкциям из всплывающих окон
4. Шаблон выполнит:
   - Создание структуры БД, используемой текущей версией z3nCore
   - Импорт необходимых данных (отмеченных чекбоксами)
...
Скачайте необходимые `.crx` расширения: [Пакет расширений](https://github.com/z3nFarm/_crx)

### Выполнение

- Открывайте шаблоны в **ZennoPoster** или **ProjectMaker**
- Убедитесь, что все зависимости установлены
- Проверьте настройку подключения к БД
- Запускайте шаблоны согласно их специфической документации

---

## 🔄 Обновления и список репозиториев

Оставайтесь в курсе последних шаблонов и улучшений:

- **Список активных шаблонов**: [Индекс репозиториев](https://t.me/c/2164296309/867/6746)
- **Анонсы**: Подписывайтесь на [@z3nLabs](https://t.me/z3nLabs) в Telegram
- **Поддержка**: Обращайтесь к [@w3bgr3p](https://t.me/w3bgr3p) за технической помощью
...
| Ресурс | Ссылка |
|--------|--------|
| **Личный Telegram** | [@w3bgr3p](https://t.me/w3bgr3p) |
| **Публичный канал** | [@z3nLabs](https://t.me/z3nLabs) |
| **Документация** | [z3n GitBook](https://z3n-1.gitbook.io/z3n/) |
| **Основной GitHub** | [@w3bgr3p](https://github.com/w3bgr3p) |
| **Библиотека z3nCore** | [z3nCore Repo](https://github.com/w3bgr3p/z3nCore) |

---

## ⚡ Чек-лист быстрого старта

- [ ] Произвести оплату и получить приглашение на GitHub
- [ ] Выбрать базу данных (SQLite или PostgreSQL)
- [ ] Установить внешние зависимости
- [ ] Настроить систему шифрования SAFU
- [ ] Запустить _dbTools для инициализации БД
- [ ] Скачать необходимые .crx расширения
